...
for idx, funding_section in enumerate(funding_sections, 1):
    ...
    # Find Funding Sources subsection
    ...
    if funding_sources:
        ...
        print("⚠️  No Funding Sources subsection found!")
    
    # Find Funding by Year subsections
    ...
    if funding_by_year:
        ...
        print("⚠️  No Funding by Year subsections found!")
